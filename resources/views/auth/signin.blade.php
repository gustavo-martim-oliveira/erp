...
<html lang="en">
  ...
  >
    ...
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
      <div
        class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 md:flex-row"
      >
        <!-- Form -->
        <div class="flex flex-col flex-1 p-5 w-full md:w-1/2">
                  ...
                  <div class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <a
                        ...
                        class="text-sm hidden text-brand-500 hover:text-brand-600 dark:text-brand-400"
                        >Forgot password?</a>
                    </div>
                    <!-- Button -->
                    <div>
        ...
        <div
          class="relative items-center w-full h-full bg-brand-950 dark:bg-white/5 md:grid md:w-1/2"
        >
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              ...
              <p class="text-center text-gray-400 dark:text-white/60">
                Free and Open-Source ERP System.
              </p>
            </div>
          </div>
        </div>
